                 ...
                 response.attendance.forEach((record, index) => {
                     let row = `
                         <tr>
                             ...
                             <td>
                                 <div class="userDatatable-content d-inline-block">
                                     <span class="bg-opacity-${record.status === 'SIGNED' ? 'success' : 'danger'} color-${record.status === 'SIGNED' ? 'success' : 'info'} rounded-pill userDatatable-content-status">${record.status}</span>
                                 </div>
                             </td>
                             <td>
